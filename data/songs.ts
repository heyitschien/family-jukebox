...
export const songs: Song[] = [
  ...
  {
    slug: "sweet-potato-soul",
    title: "Sweet Potato Soul",
    subtitle: "Track one · Garden Radio: Vegetable Grooves",
    authorSlug: "tio-chien",
    dateCreated: "2026-06-26",
    audioSrc: "/assets/tio-chien/sweet-potato-soul.mp3",
    coverSrc: "/assets/tio-chien/sweet-potato-soul.jpg",
    story:
      "A groovy tribute to sweet potatoes — soul, soil, and sunshine in one bite.",
    lyrics: songLyrics["sweet-potato-soul"],
    tags: ["garden-radio", "vegetable", "kids", "earth", "bilingual", "family-friendly", "tio-chien"],
  },
  {
    slug: "the-mycelial-loom",
    title: "The Mycelial Loom",
    subtitle: "Track two · Garden Radio: Vegetable Grooves",
    authorSlug: "tio-chien",
    dateCreated: "2026-06-26",
    audioSrc: "/assets/tio-chien/the-mycelial-loom.mp3",
    coverSrc: "/assets/tio-chien/the-mycelial-loom.jpg",
    story:
      "Underground networks, fungal magic, and the loom that weaves the forest floor.",
    lyrics: songLyrics["the-mycelial-loom"],
    tags: ["garden-radio", "vegetable", "kids", "earth", "bilingual", "family-friendly", "tio-chien"],
  },
  {
    slug: "karat-crunch",
    title: "24 Karat Crunch",
    subtitle: "Track three · Garden Radio: Vegetable Grooves",
    authorSlug: "tio-chien",
    dateCreated: "2026-06-26",
    audioSrc: "/assets/tio-chien/karat-crunch.mp3",
    coverSrc: "/assets/tio-chien/karat-crunch.jpg",
    story:
      "Carrots with main-character energy — crunch, gold, and grocery-cart swagger.",
    lyrics: songLyrics["karat-crunch"],
    tags: ["garden-radio", "vegetable", "kids", "earth", "bilingual", "family-friendly", "tio-chien"],
  },
  {
    slug: "spinach-spin",
    title: "Spinach Spin",
    subtitle: "Track four · Garden Radio: Vegetable Grooves",
    authorSlug: "tio-chien",
    dateCreated: "2026-06-26",
    audioSrc: "/assets/tio-chien/spinach-spin.mp3",
    coverSrc: "/assets/tio-chien/spinach-spin.jpg",
    story:
      "Leafy greens get a spin — playful beats for power and Popeye energy.",
    lyrics: songLyrics["spinach-spin"],
    tags: ["garden-radio", "vegetable", "kids", "earth", "bilingual", "family-friendly", "tio-chien"],
  },
  {
    slug: "watermelon-wave",
    title: "Watermelon Wave",
    subtitle: "Track one · Garden Radio: Fruit Frequency",
    authorSlug: "tio-chien",
    dateCreated: "2026-06-26",
    audioSrc: "/assets/tio-chien/watermelon-wave.mp3",
    coverSrc: "/assets/tio-chien/watermelon-wave.jpg",
    story:
      "Summer fruit, cold slices, and a wave you can dance to.",
    lyrics: songLyrics["watermelon-wave"],
    tags: ["garden-radio", "fruit", "kids", "earth", "bilingual", "family-friendly", "tio-chien"],
  },
  {
    slug: "berry-brainiacs-level-up",
    title: "Berry Brainiacs: Level Up!",
    subtitle: "Track two · Garden Radio: Fruit Frequency",
    authorSlug: "tio-chien",
    dateCreated: "2026-06-26",
    audioSrc: "/assets/tio-chien/berry-brainiacs-level-up.mp3",
    coverSrc: "/assets/tio-chien/berry-brainiacs-level-up.jpg",
    story:
      "Berries leveling up — brain food, bright colors, and kid-friendly bangers.",
