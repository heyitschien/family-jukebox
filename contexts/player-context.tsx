...
export function PlayerProvider({ children }: { children: ReactNode }) {
  const { listenerAge, audienceId } = useFamilyAudienceContext();
  ...
  const continueRadioFrom = useCallback(
    (seed: Song) => {
      const continuation = buildRadioContinuation(seed, { listenerAge, familyAudience: audienceId });
    ...
    [audienceId, listenerAge, startPlayback],
  );
