...
export function HomeFeaturedShelf({ listenerAge, audienceId, ...props }: HomeFeaturedShelfProps) {
  return <FeaturedShelf {...props} listenerAge={listenerAge} audienceId={audienceId} />;
}
