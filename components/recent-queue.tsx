      ...
      <div className="grid gap-4 lg:grid-cols-[1.2fr_0.8fr]">
          ...
          <div className="mb-4 flex flex-wrap items-end justify-between gap-3">
            <div>
              ...
              <p className="text-sm font-bold text-[var(--jb-muted)]">
                Fresh songs up front, with the rest of the list ready to roll after one tap.
              </p>
            </div>
            {recent.length > 1 ? (
              <button
        ...
        <div>
          <div className="mb-4">
            ...
            <p className="text-sm font-bold text-[var(--jb-muted)]">
              One easy starting point for the whole crew.
            </p>
          </div>
          <div className="min-h-[188px] rounded-[22px] border border-white/[0.08] bg-gradient-to-br from-white/[0.11] to-white/[0.04] p-4">
            ...
            <p className="mt-2 text-[15px] leading-relaxed text-[var(--jb-muted)]">
              Playful, colorful, and memory-first. A polished little archive of songs made
              together, grouped by the people and stories behind them.
            </p>
